...
static std::vector<Obstacle>::const_iterator find_immediate_leader(
                                                Eigen::Vector2d const& vehicle_frenet,
  ...
  for (auto obstacle = obstacles.cbegin(); obstacle != obstacles.cend(); ++obstacle) {
